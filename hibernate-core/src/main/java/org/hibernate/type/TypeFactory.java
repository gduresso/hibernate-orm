...
public final class TypeFactory implements Serializable {
	...
	public EntityType oneToOne(
			...
			String entityName,
			String propertyName) {
		return oneToOne( persistentClass, foreignKeyType, true, uniqueKeyPropertyName, lazy, unwrapProxy, entityName,
				propertyName );
	}
	...
	public EntityType specialOneToOne(
			...
			String entityName,
			String propertyName) {
		return specialOneToOne( persistentClass, foreignKeyType, true, uniqueKeyPropertyName, lazy, unwrapProxy,
	...
	public EntityType manyToOne(
		...
		return manyToOne( persistentClass, true, uniqueKeyPropertyName, lazy, unwrapProxy, ignoreNotFound,
				isLogicalOneToOne );
	}
